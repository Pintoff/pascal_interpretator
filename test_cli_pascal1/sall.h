    ...
    int parse(void) {
        ...
        while (1) {
            ...
            if (t <= 0) {
                ...
                at = sta.pop();
                n = RLEN[t];
                // проталкиваем правило в стэк в обратном порядке
                for (i = n - 1; i > -1; i--) {
    ...
    void execute() {
        ...
        while (1) {
            ...
            case OUT_ASS:
                ...
                // если присваивается char
                if (y.type == OUT_CH) val = char_asc(y.char_val);
                // если присваивается word | bool
                else val = y.word_val;
                // если переменная char
                ...
                // обозначаем что переменная инициализирована
